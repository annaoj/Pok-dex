...
// CONCATENATED MODULE: ./components/Pokemon/Pokemon.js
...
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(Pokemon, _Component);

  function Pokemon(props) {
    var _this;

    Object(classCallCheck["a" /* default */])(this, Pokemon);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Pokemon).call(this, props));
    _this.state = {
      errors: {},
      name: '',
      imgUrl: '',
  ...
  Object(createClass["a" /* default */])(Pokemon, [{
    ...
    value: function render() {
      ...
      if (!this.props) return external_react_default.a.createElement("div", null, external_react_default.a.createElement("p", null, "Error with data"));
      return external_react_default.a.createElement("div", {
      ...
      }, url)), external_react_default.a.createElement("div", {
      ...
      }, "Info"))))), external_react_default.a.createElement(style_default.a, {
        id: "392504929"
...
/* harmony default export */ var components_Pokemon_Pokemon = (Pokemon_Pokemon);
// CONCATENATED MODULE: ./components/Pokemon/PokemonList.js
...
var PokemonList_PokemonList =
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(PokemonList, _Component);

  function PokemonList(props) {
    var _this;

    Object(classCallCheck["a" /* default */])(this, PokemonList);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(PokemonList).call(this, props));
    _this.state = {
      errors: {}
    };
    return _this;
  ...
  Object(createClass["a" /* default */])(PokemonList, [{
    key: "render",
    value: function render() {
      var pokemonData = this.props.pokemonData;
      if (!pokemonData) return external_react_default.a.createElement("div", null, external_react_default.a.createElement("p", null, "Error with data")); // console.log(pokemonData.pokemon_entries);

      return external_react_default.a.createElement("div", {
        className: "row"
      }, pokemonData ? pokemonData.pokemon_entries.map(function (poke, i) {
        // pokemonData.results.map((poke, i) => {
        return external_react_default.a.createElement(components_Pokemon_Pokemon // key={i}
        // name={poke.name}
        // url = {poke.url}
        , {
          key: i,
      ...
      }) : external_react_default.a.createElement("h1", null, " Loading ")) // <div className="row">
...
/* harmony default export */ var Pokemon_PokemonList = (PokemonList_PokemonList);
  ...
  Object(createClass["a" /* default */])(Index, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(Layout["a" /* default */], null, external_react_default.a.createElement("div", {
        className: "container"
      }, external_react_default.a.createElement("h1", null, "Welcome to Pokedex.org"), external_react_default.a.createElement(Pokemon_PokemonList, {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                _context.next = 5;
                return external_axios_default()("https://pokeapi.co/api/v2/pokedex/1");
